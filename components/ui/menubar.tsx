...
>(({ className, asChild, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn("flex h-10 items-center space-x-1 rounded-full bg-transparent p-1", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex w-fit cursor-default rounded-md select-none items-center px-3 py-1.5 text-sm font-medium outline-none focus:bg-stone-100 focus:text-stone-900 data-[state=open]:bg-stone-100 data-[state=open]:text-stone-900 dark:focus:bg-slate-700 dark:focus:text-stone-50 dark:data-[state=open]:bg-slate-700 dark:data-[state=open]:text-stone-50",
      className
    )}
    {...props}
  />
