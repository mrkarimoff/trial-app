    ...
    <div className="flex justify-center my-20">
      <Card className="w-[400px] mx-2">
        <CardHeader>
          ...
          <CardDescription>
            Your current role is <span className="text-red-400 font-semibold">{user?.role}</span>
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <span className="text-sm text-black dark:text-white">Change to Participant</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-sm text-black dark:text-white">Change to User </span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-sm text-black dark:text-white">Change to Admin </span>
            </button>
          </div>
        </CardContent>
      </Card>
